...
module.exports = {
    ...
    "ar": "`.ar` domains can only be checked at http://www.nic.ar. To make the request enter the domain in Buscar Dominios",
    ...
    "az": "`.az` domains have no whois server but you can check whois at http://nic.az",
